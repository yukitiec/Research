                    ...
                    for (int j = 0; j < updatedPositionsHuman[i].size(); j++)
                    {
                        ...
                        if (updatedPositionsHuman[i][j][1] > 0)
                        {
                            if (posSaver.back()[i][j][1] > 0 && posSaver.back()[i][j][2] > 0) //previous data exists
                            {
                                ...
                                //if ((float)(std::abs((posSaver.back()[i][j][1]+ posSaver.back()[i][j][3]/2) - (updatedPositionsHuman[i][j][1]+ updatedPositionsHuman[i][j][3]/2))) < MAX_CHANGE && (float)(std::abs((posSaver.back()[i][j][2]+ posSaver.back()[i][j][4]/2) - (updatedPositionsHuman[i][j][2]+ updatedPositionsHuman[i][j][4]/2))) < MAX_CHANGE)
                                //{
