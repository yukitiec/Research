...
void Triangulation::getData(std::vector<std::vector<std::vector<int>>>& data_left, std::vector<std::vector<std::vector<int>>>& data_right)
{
...
void Triangulation::triangulation(std::vector<std::vector<std::vector<int>>>& data_left, std::vector<std::vector<std::vector<int>>>& data_right,
...
void Triangulation::cal3D(std::vector<int>& left, std::vector<int>& right, std::vector<int>& result)
{
